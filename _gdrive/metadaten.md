...
Forschungsdaten (siehe (**sec-digitalisierung?**) und
(**sec-forschungsnahe-dienste?**)). Viele der im Folgenden beschriebenen
Grundlagen zu Eigenschaften, Arten und Verarbeitung von Daten gelten
sowohl für Metadaten als auch für digitale Inhalte.
...
eine Serialisierung, sodass Format und Syntax meist synonym verwendet
...
<figure>
<img src="media/rId22.svg" style="width:0in;height:0in"
alt="ER-Diagramm zur Beschreibung eines Datenmodells von Sitzbänken" />
<figcaption aria-hidden="true"><p>ER-Diagramm zur Beschreibung eines
Datenmodells von Sitzbänken</p></figcaption>
</figure>
...
*EN 15907*, *EAD* ..., siehe (**sec-digitalisierung?**)) und für
Forschungsdaten (DataCite, siehe (**sec-forschungsnahe-dienste?**)) gibt
...
in XML (siehe (**fig-marcxml?**)) und JSON kodiert werden. Viele
Eigenheiten und Probleme des Formats sind historisch bedingt, die
Alternative BIBFAME konnte sich noch nicht durchsetzen.
...
**METS** und **MODS** sind zwei zusammen im Bereich Digitalisierung
(siehe (**sec-digitalisierung?**)) eingesetzte Formate für strukturelle
und administrative (METS) sowie bibliografische Metadaten (MODS).
Strukturdaten in METS ermöglichen granulare Gliederung und Verlinkung
von Objekten, wobei mögliche Typen und Beziehungen in Regelsätzen
definiert sind.
...
Beschreibung von Forschungsdaten (siehe
(**sec-forschungsnahe-dienste?**)).
...
ausgedrückt mit der BIBFRAME-Ontologie und URIs aus K10plus und
Wikidata.
...
Integration von Metadaten in ein Discovery-System (siehe
(**sec-discovery?**)) beschrieben. (**fig-etl?**) illustriert den
generellen ETL-Prozess.

<figure>
<img src="media/rId44.svg" style="width:5.83333in;height:2.64081in"
alt="Allgemeiner Ablauf eines ETL-Prozesses" />
<figcaption aria-hidden="true"><p>Allgemeiner Ablauf eines
ETL-Prozesses</p></figcaption>
</figure>
...
beispielsweise in einem Discovery-System ((**sec-discovery?**))
...
Suchindex eines Discovery-Systems (siehe (**sec-discovery?**)). Dabei
...
Solr*. Besonders im Bereich forschungsnaher Dienste (siehe
(**sec-forschungsnahe-dienste?**)) gibt es weitere, spezialisierte
Schnittstellen.
...
-   Verfahren zur Analyse und Anreicherung von Daten, beispielsweise die
    ...
    Digitalisierung (siehe (**sec-digitalisierung?**)).
