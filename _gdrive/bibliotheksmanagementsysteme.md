...
Management-Tools und Datenbanken („Knowledge Base") wie *Coral*, *GOKb*
und *LAS:eR* an.
...
der Bibliothek auch direkt den Nutzer\*innen möglichst mit der
Funktionalität eines [Discovery-Systems](discovery.md) zur Verfügung zu
stellen:
