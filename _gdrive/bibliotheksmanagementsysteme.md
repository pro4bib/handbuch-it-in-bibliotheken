...
<figure>
<img src="media/rId21.svg" style="width:4.16667in;height:2.77778in"
alt="Evolution der Bibliotheksmanagementsysteme (nach Matthews und Block (2020), S. 7)" />
<figcaption aria-hidden="true"><p>Evolution der
Bibliotheksmanagementsysteme (nach Matthews und Block (2020), S.
7)</p></figcaption>
</figure>
...
sich aktuell immer noch im Einsatz. FOLIO wurde bereits im Rahmen des
*Open Library Environment Project* 2009 initiiert und wird
...
der Bibliothek (siehe Abschnitt [Prozessabbildung](#prozessabbildung)).
Diese Daten sind zum größten Teil nicht öffentlich und müssen
insbesondere im Falle von Daten von Nutzer\*innen im Rahmen des
[Datenschutzes](#datenschutz-etc) vertraulich behandelt werden.
...
$\Rightarrow$ *Das (**sec-digitalisierung?**) geht ausführlicher auf
...
Betriebs-](management.md#sec-betriebsmodelle) und Geschäftsmodells oder
auch die Mitgliedschaft in einem Verbund als Kriterien heranzuziehen.
...
können. Die Anforderungen aus dem Abschnitt [Nutzer\*innenorientierte
Gestaltung](#sec-nutzerinnenorientierte-gestaltung) gelten grundsätzlich
natürlich auch hier.
...
<figure>
<img src="media/rId62.svg" style="width:3.5in;height:2.33333in"
alt="Beispiel für eine Matrix zur Einordnung von Funktionalitäten" />
<figcaption aria-hidden="true"><p>Beispiel für eine Matrix zur
Einordnung von Funktionalitäten</p></figcaption>
</figure>
...
<figure>
<img src="media/rId71.svg" style="width:0in;height:0in"
alt="Auszug einer BPMN-Prozessabbildung am Beispiel der verspäteten Buchrückgabe" />
<figcaption aria-hidden="true"><p>Auszug einer BPMN-Prozessabbildung am
Beispiel der verspäteten Buchrückgabe</p></figcaption>
</figure>
...
Rahmenbedingungen](#rechtliche-rahmenbedingungen) und in
(**sec-anforderungen?**) zu den Anforderungen an Bibliotheks-IT
angesprochen.
...
3.  Discovery-System (siehe (**sec-discovery?**)) als Bestandteil des
...
4.  Discovery-System als zugekauftes Modul eines anderen Herstellers
    oder als Eigenbau mit zugekauften Metadaten oder als Open Source mit
...
Die wichtigsten [Automaten](#automaten), die in Bibliotheken anzutreffen
sind, sind Ausleihautomaten / Selbstverbucher, Rückgabeautomaten,
Fernleihautomaten und Kassenautomaten.
...
3.  Anbindung an Tools für statistische Auswertungen (s.a. Abschnitt
    [Statistik](#statistik))
...
7.  Schnittstellen zu IDM-Systemen (s.a. Abschnitt
...
[Datenschutz](#datenschutz-etc) im Abschnitt zum [technischen Betrieb
eines BMS](#sec-technischer-betrieb).
...
[Betriebsmodell](management.md#sec-betriebsmodelle) (lokale
Installation, gehostete Variante oder Cloud-Dienst). [Kosten](#kosten)
...
Allgemein gelten die im (**sec-sicherheit?**) beschriebenen Richtlinien,
Maßnahmen und Empfehlungen sowie der Grundsatz: „Bleiben Sie wachsam, in
Bezug auf ungewöhnliche Ereignisse auf Ihren IT-Systemen".
...
Abschnitt [Automatisierung)](#automatisierung-und-selbstbedienung).
...
Auch im Kontext eines BMS greift der [Datenschutz](#datenschutz) im
Sinne der Datenschutz-Grundverordnung (DSGVO), die anfallenden
...
(**sec-betriebsmodelle?**)) müssen insbesondere die Regeln für den
[datenschutzkonformen Betrieb](sicherheit.html#datenschutz) eingehalten
werden.
...
Borgman, Christine L. 1997. „From Acting Locally to Thinking Globally: A
